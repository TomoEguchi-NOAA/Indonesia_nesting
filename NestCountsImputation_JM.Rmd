...
Interesting to see that those models that are acceptable according to Pareto k statistics are worse ones according to looic scores. I will use M5 (the best according to looic alone), M13 (best looking at Pareto k statistics alone), and M8 (best among acceptable Pareto k statisitcs models). 

Model 5, 

Posterior distributions of thetas:

```{r posterior_M5_theta, fig.cap="Figure. Posterior distributions of slope parameters for M5"}
m <- 5
best.jm <- M5.jm
bayesplot::mcmc_dens(best.jm$samples, c("theta.1[1]", "theta.1[2]", "theta.1[3]", "theta.1[4]",
                                      "theta.1[5]", "theta.1[6]", "theta.1[7]", "theta.1[8]",
                                      "theta.1[9]", "theta.1[10]", "theta.1[11]", "theta.1[12]"))
```

Posterior distributions of sigma.pro1:

```{r posterior_M5_theta, fig.cap="Figure. Posterior distributions of slope parameters for M5"}
bayesplot::mcmc_dens(best.jm$samples, c("sigma.pro1[1]", "sigma.pro1[2]", 
                                      "sigma.pro1[3]", "sigma.pro1[4]",
                                      "sigma.pro1[5]", "sigma.pro1[6]",
                                      "sigma.pro1[7]", "sigma.pro1[8]",
                                      "sigma.pro1[9]", "sigma.pro1[10]",
                                      "sigma.pro1[11]", "sigma.pro1[12]"))
```
...
```{r posterior_M13, fig.cap="Figure. Posterior distribuitons of slope parameters for M13"}
#m <- 13
best2.jm <- M13.jm
bayesplot::mcmc_dens(best2.jm$samples, c("theta.1", "theta.2"))
```

```{r posterior_M13_df, fig.cap="Figure. Posterior distributions of degrees-of-freedom parameter for M13"}

bayesplot::mcmc_dens(best2.jm$samples, "df")
```
The slope parameters indicated increasing trend to July and decreased from August through November. 

```{r posterior_M13_2, fig.cap="Figure. Posterior distributions for the standard deviation of the process (sigma.pro1) and standard deviation of observations (sigma.obs)."}
bayesplot::mcmc_dens(best2.jm$samples, c("sigma.pro1", "sigma.obs"))
```
...
best3.jm <- M8.jm
bayesplot::mcmc_dens(best3.jm$samples, c("theta.1[1]", "theta.1[2]", "theta.1[3]", "theta.1[4]",
                                      "theta.1[5]", "theta.1[6]", "theta.1[7]", "theta.1[8]",
                                      "theta.1[9]", "theta.1[10]", "theta.1[11]", "theta.1[12]"))
```
...
bayesplot::mcmc_dens(best3.jm$samples, c("sigma.pro1", "sigma.obs"))
```


We use these models to impute missing data points and compared results.
...
Qualitatively... M8 seems to provide "better" predictions. So, go with that. 
...
write.csv(Xy.season, 
          file = paste0("data/estimatedX_JM_M", m, ".csv"),
          quote = F, row.names = F)
