...
Interesting to see that those models that are acceptable according to Pareto k statistics are worse ones according to looic scores. I will use M5 (the best according to looic alone), M2 (best looking at Pareto k statistics alone), and M8 (best among acceptable Pareto k statisitcs models). 
...
```{r posterior_M5_sigma, fig.cap="Figure. Posterior distributions of slope parameters for M5"}
...
```{r posterior_M2, fig.cap="Figure. Posterior distribuitons of slope parameters for M2"}
#m <- 13
best2.jm <- M2.jm
