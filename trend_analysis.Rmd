...
```{r}
U.stats <- paste0(signif(jags.model$out$summary["U[1]", "50%"], 2), 
                  " [", signif(jags.model$out$summary["U[1]", "2.5%"], 2), ", ", 
                  signif(jags.model$out$summary["U[1]", "97.5%"], 2), "]")

p.1.U1 <- bayesplot::mcmc_dens(jags.model$out$samples, "U[1]")
...
U.stats <- paste0(signif(jags.model$out$summary["U[2]", "50%"], 2), 
                  " [", signif(jags.model$out$summary["U[2]", "2.5%"], 2), ", ", 
                  signif(jags.model$out$summary["U[2]", "97.5%"], 2), "]")

p.1.U2 <- bayesplot::mcmc_dens(jags.model$out$samples, "U[2]")
