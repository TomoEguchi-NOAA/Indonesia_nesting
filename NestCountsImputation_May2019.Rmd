...
```{r}
p.JM.imputed <- plot.imputed(M1.Xs.stats, M1.ys.stats, "JM", 
...
```{r }
p.JM.estimated.counts <- plot.combined.counts(M1.jm, 
                                              M1.Xs.stats, 
                                              M1.ys.stats, 
                                              run.date, 
                                              "JM", 
...
```{r}
p.W.imputed <- plot.imputed(M4.Xs.stats, M4.ys.stats, "W", year.begin.W, year.end.W)
...
```{r }
p.W.estimated.counts <- plot.combined.counts(M4.jm, 
                                             M4.Xs.stats, 
                                             M4.ys.stats, 
                                             run.date, "W", 4)
