...
```{r}
JM_out <- model.Comparison.Fourier("JM")
W_out <- model.Comparison.Fourier("W")
```
...
M1.loo.out <- JM_out[[1]]$loo.out$loo.out
M1.jm <- JM_out[[1]]$jags.out
M1.Xs.stats <- JM_out[[1]]$Xs.stats
M1.ys.stats <- JM_out[[1]]$ys.stats
data.y <-JM_out[[1]]$data.y
```
...
plots <- PSIS.plots(pareto.k, data.y, "1")
if (save.fig)
  ggsave(plots$p2, filename = "figures/JM_PSIS_M1.png",
         device = "png", dpi = 600)
...
m <- 2
M2.loo.out <- JM_out[[m]]$loo.out$loo.out
M2.jm <- JM_out[[m]]$jags.out
M2.Xs.stats <- JM_out[[m]]$Xs.stats
M2.ys.stats <- JM_out[[m]]$ys.stats
data.y <-JM_out[[m]]$data.y
```
...
plots <- PSIS.plots(pareto.k, data.y, "2")
if (save.fig)
...
m <- 3
M3.loo.out <- JM_out[[m]]$loo.out$loo.out
M3.jm <- JM_out[[m]]$jags.out
M3.Xs.stats <- JM_out[[m]]$Xs.stats
M3.ys.stats <- JM_out[[m]]$ys.stats
data.y <-JM_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "3")
if (save.fig)
  ggsave(plots$p2, filename = "figures/JM_PSIS_M3.png",
         device = "png", dpi = 600)
...
m <- 4
M4.loo.out <- JM_out[[m]]$loo.out$loo.out
M4.jm <- JM_out[[m]]$jags.out
M4.Xs.stats <- JM_out[[m]]$Xs.stats
M4.ys.stats <- JM_out[[m]]$ys.stats
data.y <-JM_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "4")
if (save.fig)
  ggsave(plots$p2, filename = "figures/JM_PSIS_M4.png",
         device = "png", dpi = 600)
...
m <- 5
M5.loo.out <- JM_out[[m]]$loo.out$loo.out
M5.jm <- JM_out[[m]]$jags.out
M5.Xs.stats <- JM_out[[m]]$Xs.stats
M5.ys.stats <- JM_out[[m]]$ys.stats
data.y <-JM_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "5")
if (save.fig)
  ggsave(plots$p2, filename = "figures/JM_PSIS_M5.png",
         device = "png", dpi = 600)
...
m <- 6
M6.loo.out <- JM_out[[m]]$loo.out$loo.out
M6.jm <- JM_out[[m]]$jags.out
M6.Xs.stats <- JM_out[[m]]$Xs.stats
M6.ys.stats <- JM_out[[m]]$ys.stats
data.y <-JM_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "6")
if (save.fig)
  ggsave(plots$p2, filename = "figures/JM_PSIS_M6.png",
         device = "png", dpi = 600)
...
```{r model1, cache=TRUE, include=TRUE}
m <- 1
M1.loo.out <- W_out[[m]]$loo.out$loo.out
M1.jm <- W_out[[m]]$jags.out
M1.Xs.stats <- W_out[[m]]$Xs.stats
M1.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
```
...
plots <- PSIS.plots(pareto.k, data.y, "1")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M1.png",
         device = "png", dpi = 600)
...
```{r model2, cache=TRUE, include=TRUE}
m <- 2
M2.loo.out <- W_out[[m]]$loo.out$loo.out
M2.jm <- W_out[[m]]$jags.out
M2.Xs.stats <- W_out[[m]]$Xs.stats
M2.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "2")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M2.png",
         device = "png", dpi = 600)
...
```{r model3, cache=TRUE, include=TRUE}
m <- 3
M3.loo.out <- W_out[[m]]$loo.out$loo.out
M3.jm <- W_out[[m]]$jags.out
M3.Xs.stats <- W_out[[m]]$Xs.stats
M3.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "3")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M3.png",
         device = "png", dpi = 600)
...
```{r model10, cache=TRUE, include=TRUE}
m <- 4
M4.loo.out <- W_out[[m]]$loo.out$loo.out
M4.jm <- W_out[[m]]$jags.out
M4.Xs.stats <- W_out[[m]]$Xs.stats
M4.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "4")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M4.png",
         device = "png", dpi = 600)
...
```{r model5, cache=TRUE, include=TRUE}
m <- 5
M5.loo.out <- W_out[[m]]$loo.out$loo.out
M5.jm <- W_out[[m]]$jags.out
M5.Xs.stats <- W_out[[m]]$Xs.stats
M5.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "5")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M5.png",
         device = "png", dpi = 600)
...
```{r model6, cache=T, include=TRUE}
m <- 6
M6.loo.out <- W_out[[m]]$loo.out$loo.out
M6.jm <- W_out[[m]]$jags.out
M6.Xs.stats <- W_out[[m]]$Xs.stats
M6.ys.stats <- W_out[[m]]$ys.stats
data.y <-W_out[[m]]$data.y
...
plots <- PSIS.plots(pareto.k, data.y, "6")
if (save.fig)
  ggsave(plots$p2, filename = "figures/W_PSIS_M6.png",
         device = "png", dpi = 600)
