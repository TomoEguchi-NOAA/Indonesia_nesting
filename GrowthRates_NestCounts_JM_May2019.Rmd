...
This document uses the best model from NestCountsImputatoin_JM_May2019.Rmd to compute the annual change in nest counts over the time period (Nt/Nt-1). The best model was determined as Model 7.

```{r}
run.date <- "2019-05-01"
m <- 1   # best model number - comes from NestCountImputation_JM_May2019.Rmd.
year.begin <- 1999
year.end <- 2019
