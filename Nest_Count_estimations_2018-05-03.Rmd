...
Because of the  nearshore currents are different between summer and winter so it may make more sense to look at trends for winter and summer counts separately. So, we have to pull in the predicted numbers from model outputs. First from Wermon. 
...
Even in the non-log scale, the increase in the last five years seems obvious... 
