...
Among the "good" k pareto statistics models, M7 is the best from looic values. So, let's take a look at the posteriors. 
...
write.csv(Xy.season, 
          file = paste0("data/estimatedX_W_M", m, ".csv"),
          quote = F, row.names = F)
