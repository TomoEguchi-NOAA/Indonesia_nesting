...
p.1 <- ggplot() +
  ...
  geom_point(data = Xs.stats,
             aes(x = time, y = exp(median_X)), color = "purple",
             alpha = 0.5) +
  geom_line(data = Xs.stats,
            aes(x = time, y = exp(median_X)), color = "purple",
            alpha = 0.5) +
...
print(p.1)
ggsave(plot = p.1,
       filename = "figures/estimated_counts_W.png",
       device = "png",
       dpi = 600)
```
...
print(p.W.estimated.counts)
# ggsave(plot = p.W.estimated.counts,
#        filename = "figures/estimated_counts_perSeason_W.png",
#        device = "png",
#        dpi = 600)
