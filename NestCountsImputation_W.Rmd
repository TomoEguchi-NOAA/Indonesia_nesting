...
M <- readRDS(paste0("RData/jagsout_", str.root, "_W_2006_2014_",
                    run.date, ".rds"))
...
#Model comparison
Estimated Pareto k statistics indicated that models 7, 8, 11, and 17 had better predictive performance than the rest. We compared these models using using ELPD values.
...
bayesplot::mcmc_dens(M7.jm$samples, c("sigma.pro1", "sigma.pro2", "sigma.obs"))
```
...
```{r}
M <- readRDS(paste0("RData/jagsout_", str.root, "_W_2006_2017_",
                    run.date, ".rds"))
...
write.csv(Xs.season, 
          file = "data/estimatedX_W_M17.csv",
          quote = F, row.names = F)
