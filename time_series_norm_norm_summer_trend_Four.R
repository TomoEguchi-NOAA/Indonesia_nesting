...
if (file.exists(paste0('RData/SSAR1_norm_norm_summer_trend_Four_', loc, "_",
                       year.begin, "_", year.end, "_", run.date, '.rds'))){
  results.all <- readRDS(file = paste0('RData/SSAR1_norm_norm_summer_trend_Four_', loc, "_",
                                       year.begin, "_", year.end, "_", run.date, '.rds'))
