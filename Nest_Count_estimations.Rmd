...
```{r}
load("RData/SSAR1_month_JM_2001_2018-04-24.RData")
...
```{r}
load('RData/SSAR1_month_JM_var_theta_2001_2018-04-24.RData')
...
So, it is more likely that the slope is positive (p = ```r p.pos```) - BUT the uncertainty is exaggerated so the picture is not as rosy as it seems in this plot. 
