...
data.extract <- function(location, 
                         ...
                         season.end = year.end){
  # In July 2020, I received new data for 2019. So, the raw data files
  # have been updated.  
...
years <- rep(2001:year.end, each = 12)
...
What are these bimodal stuff doing here?


```{r}
# process SD for two beaches:

bayesplot::mcmc_trace(jm$samples, c("sigma.y[1]", "sigma.y[2]"))
```
...
bayesplot::mcmc_trace(jm$samples, c("sigma.X[1]", "sigma.X[2]"))
```
