  ...
  for (k1 in 1:length(model.names)){
    ...
    pareto.df <- data.frame(y = data.y,
                            ...
                            k0.7 = cut(pareto.k,
                                       breaks = c(0, 0.7, 1.5),
                                       labels = c("<=0.7", ">0.7")))
    pareto.plots[[c]] <- ggplot(data = pareto.df) +
...
out.obj <- c(loo.out, pareto.plots)
