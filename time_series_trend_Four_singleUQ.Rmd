...
filename.root <- paste0("SSAR1_norm_norm_trend_Four_singleUQ_",
...
jm <- jags(jags.data,
           ...
           model.file = 'models/model_norm_norm_trend_Four_singleUQ.txt',
...
Extract looic and Pareto k statistics
```{r}
# 
...
bayesplot::mcmc_dens(jm$samples, c("sigma.Q"))
