...
if(!file.exists(paste0("RData/singleUQ_JM_only_M", JM.bestM, "_", 
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_JM_only_M", JM.bestM, "_", 
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_JM_only_M", JM.bestM, "_",
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
}
...
if (save.fig)
  ...
  ggsave(p.1,
         filename = paste0("figures/posterior_U_JM_only_M", JM.bestM, ".png"),
         device = "png",
         dpi = 600,
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/JM_only_trend_annual_log_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/JM_only_trend_annual_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_JM_only_summer_M", JM.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.JM, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_JM_only_summer_M", JM.bestM, "_", 
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_JM_only_summer_M", JM.bestM, "_", 
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
}
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_JM_only_summer_M", JM.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
print(p.1)
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/JM_only_trend_summer_log_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/JM_only_trend_summer_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_JM_only_winter_M", JM.bestM, "_",
                       begin.year.JM, "_", end.year, "_", run.date.JM, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_JM_only_winter_M", JM.bestM, "_",
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_JM_only_winter_M", JM.bestM, "_",
                                begin.year.JM, "_", end.year,  "_", run.date.JM, ".rds"))
}
...
p.1 <- bayesplot::mcmc_dens(jm.out$out$samples, "U")
p.1 <- p.1 + labs(y = "Density", x = "", 
                  title = "Jamursba-Medi (Winter, one dataset)") +
  xlim(c(-1.1, 1.1)) +
  ylim(c(0, posterior.lim.y)) + 
  geom_text(aes(x = 0.5, y = text.y), 
            label = U.stats, hjust =  "left") + 
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_JM_only_winter_M", JM.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
print(p.1)
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/JM_only_trend_winter_log_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/JM_only_trend_winter_M", JM.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_W_only_M", W.bestM, "_", 
                       begin.year.W, "_", 
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_W_only_M", W.bestM, "_",
                                begin.year.W, "_",
                                end.year,  "_", run.date.W, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_W_only_M", W.bestM, "_",
                                  begin.year.W, "_",
                                  end.year,  "_", run.date.W, ".rds"))
}
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_W_only_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
print(p.1)
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/W_only_trend_annual_log_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/W_only_trend_annual_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_W_only_summer_M", W.bestM, "_",
                       begin.year.W, "_",
                       end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_W_only_summer_M",  W.bestM, "_",
                                begin.year.W, "_",
                                end.year,  "_", run.date.W, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_W_only_summer_M",  W.bestM, "_",
                                  begin.year.W, "_",
                                  end.year,  "_", run.date.W, ".rds"))
}
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_W_only_summer_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
print(p.1)
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/W_only_trend_summer_log_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/W_only_trend_summer_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_W_only_winter_M", W.bestM, "_", 
                       begin.year.W, "_",
                       end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_W_only_winter_M", W.bestM, "_", 
                                begin.year.W, "_",
                                end.year,  "_", run.date.W, ".rds"))
  print(jm.out$out)

} else {
  jm.out <- readRDS(file = paste0("RData/singleUQ_W_only_winter_M", W.bestM, "_", 
                                  begin.year.W, "_",
                                  end.year,  "_", run.date.W, ".rds"))
}
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_W_only_winter_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
print(p.1)
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/W_only_trend_winter_log_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, filename = paste0("figures/W_only_trend_winter_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
```{r}
if(!file.exists(paste0("RData/independentUs_singleQ_out_JM_M", 
                       JM.bestM, "_W_M", W.bestM, "_", 
  ...
  saveRDS(jm.out, file = paste0("RData/independentUs_singleQ_out_JM_M", 
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} else {
  jm.out <- readRDS(file = paste0("RData/independentUs_singleQ_out_JM_M",
                                  JM.bestM, "_W_M", W.bestM, "_",
                                  begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
...
if (save.fig)
  ggsave(p.1.U1,
         filename = paste0("figures/posterior_U_JM_indUs_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1.U2,
         filename = paste0("figures/posterior_U_W_indUs_JM_M", 
         JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/JM_trend_annual_indU_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/JM_trend_annual_indU_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.2.log, 
         filename = paste0("figures/W_trend_annual_indU_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.2, 
         filename = paste0("figures/W_trend_annual_indU_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if(!file.exists(paste0("RData/singleUQ_out_JM_M", JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                                begin.year.JM, "_", end.year,  "_", run.date.W, ".rds"))
  print(jm.out$out)
...
if(!file.exists(paste0("RData/independentUQ_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  ...
  saveRDS(jm.out, file = paste0("RData/independentUQ_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r}
if(!file.exists(paste0("RData/independentQs_singleU_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  ...
  saveRDS(jm.out, file = paste0("RData/independentQs_singleU_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
```
...
```{r}
jags.model <- readRDS(paste0("RData/singleUQ_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
...
if (save.fig)
  ggsave(p.1.log, 
         filename = paste0("figures/JM_trend_annual_log_JM_M", 
         JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1, 
         filename = paste0("figures/JM_trend_annual_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.2.log, 
         filename = paste0("figures/W_trend_annual_log_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.2, 
         filename = paste0("figures/W_trend_annual_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_singleU_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
```{r}
if(!file.exists(paste0("RData/singleUQ_summer_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_summer_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
...
```{r}
if(!file.exists(paste0("RData/independentUQ_summer_out_JM_M",JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  ...
  saveRDS(jm.out, file = paste0("RData/independentUQ_summer_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r}
if(!file.exists(paste0("RData/independentQs_singleU_summer_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_",
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_independentQs_singleU.txt"
  ...
  saveRDS(jm.out, file = paste0("RData/independentQs_singleU_summer_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r}
if(!file.exists(paste0("RData/independentUs_singleQ_summer_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_",
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_independentUs_singleQ.txt"
  ...
  saveRDS(jm.out, file = paste0("RData/independentUs_singleQ_summer_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r}
jags.model_summer <- readRDS(paste0("RData/singleUQ_summer_out_JM_M",
                                    JM.bestM, "_W_M", W.bestM, "_",
                             begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
...
if (save.fig)
  ggsave(p.3, 
         filename = paste0("figures/JM_trend_summer_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3.log, 
         filename = paste0("figures/JM_trend_summer_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.4, 
         filename = paste0("figures/W_trend_summer_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.4.log, 
         filename = paste0("figures/W_trend_summer_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_summer_JM_M",
                           JM.bestM, "_W_M", W.bestM,  ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
```{r}
jags.model_summer <- readRDS(paste0("RData/independentUs_singleQ_summer_out_JM_M",
                                    JM.bestM, "_W_M", W.bestM, "_",
                                    begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
jags.data_summer <- jags.model_summer$jags.data
...
if (save.fig)
  ggsave(p.3, 
         filename = paste0("figures/JM_trend_summer_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM,  ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3.log, 
         filename = paste0("figures/JM_trend_summer_log_independentUs_JM_M", 
                           JM.bestM, "_W_M", W.bestM,  ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_summer_JM_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM,  ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3, 
         filename = paste0("figures/W_trend_summer_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3.log, 
         filename = paste0("figures/W_trend_summer_log_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_summer_W_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
```{r}
if(!file.exists(paste0("RData/singleUQ_winter_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W,  ".rds"))){
  jags.params <- c("A", "U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_singleUQ.txt"
  ...
  jm.out$data <- thedata
  saveRDS(jm.out, file = paste0("RData/singleUQ_winter_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_", 
                                begin.year.JM, "_", end.year,  "_", run.date.W, ".rds"))
  print(jm.out$out)
...
```{r}
if(!file.exists(paste0("RData/independentUQ_winter_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_", 
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_independentUQs.txt"
  ...
  saveRDS(jm.out, file = paste0("RData/independentUQ_winter_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r results=FALSE}
if(!file.exists(paste0("RData/independentQs_singleU_winter_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_",
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_independentQs_singleU.txt"
  ...
  saveRDS(jm.out, file = paste0("RData/independentQs_singleU_winter_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r echo=FALSE}
if(!file.exists(paste0("RData/independentUs_singleQ_winter_out_JM_M",
                       JM.bestM, "_W_M", W.bestM, "_",
                       begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))){
  jags.params <- c("U", "Q", "R", "X0", "X", "loglik")
  model.loc <- "models/model_independentUs_singleQ.txt"
  ...
  saveRDS(jm.out, file = paste0("RData/independentUs_singleQ_winter_out_JM_M",
                                JM.bestM, "_W_M", W.bestM, "_",
                                begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
  print(jm.out$out)
} 
...
```{r}
jags.model_winter <- readRDS(paste0("RData/singleUQ_winter_out_JM_M",
                                    JM.bestM, "_W_M", W.bestM, "_",
                                    begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
...
if (save.fig)
  ggsave(p.5, 
         filename = paste0("figures/JM_trend_winter_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.5.log, 
         filename = paste0("figures/JM_trend_winter_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.6, 
         filename = paste0("figures/W_trend_winter_JM_M",
                           JM.bestM, "_W_M", W.bestM,  ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.6.log, 
         filename = paste0("figures/W_trend_winter_log_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_winter_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
```{r}
jags.model_winter <- readRDS(paste0("RData/independentUs_singleQ_winter_out_JM_M", 
                                    JM.bestM, "_W_M", W.bestM, "_", 
                                    begin.year.JM, "_", end.year, "_", run.date.W, ".rds"))
jags.data_winter <- jags.model_winter$jags.data
...
if (save.fig)
  ggsave(p.3, 
         filename = paste0("figures/JM_trend_winter_independentUs_JM_M", 
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3.log, 
         filename = paste0("figures/JM_trend_winter_log_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_winter_JM_independentUs",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3, 
         filename = paste0("figures/W_trend_winter_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.3.log, 
         filename = paste0("figures/W_trend_winter_log_independentUs_JM_M",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png", dpi = 600,
         height = 4, width = 6, units = "in")
...
if (save.fig)
  ggsave(p.1,
         filename = paste0("figures/posterior_U_winter_W_independentUs",
                           JM.bestM, "_W_M", W.bestM, ".png"),
         device = "png",
         dpi = 600,
         height = 4, width = 6, units = "in")
