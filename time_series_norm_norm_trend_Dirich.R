...
bayesplot::mcmc_trace(jm$samples, "alpha[1]")
...
if (save.fig){
  ...
  ggsave(filename = paste0('figures/SSAR1_norm_norm_log_trend_Dirich_', loc, "_",
                           year.begin, "_", year.end, "_", Sys.Date(), ".png"),
         plot = p.1a,
         dpi = 600,
         device = "png")
