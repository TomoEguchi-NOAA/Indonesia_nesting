...
Among the 8 models fit to the Wermon dataset, only ```r length(good.models.W)``` models were found appropriate based on the Pareto k statistic (Table x). The best model included Student's t distribution for state and observation processes, whereas the second best model was with the normal disttibution for the state and Student's t distribution for the observation. Convergence was reached for both models, where maximum Rhat < 1.01. 
