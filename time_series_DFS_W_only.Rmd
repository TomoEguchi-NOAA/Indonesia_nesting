---
title: "Location specific (just W) analysis"
...
y <- array(data= NA, dim = c(nrow(data.jags.W$jags.data2$y),
                             ncol(data.jags.W$jags.data2$y), 1))
y[,,1] <- data.jags.W$jags.data2$y
...
jags.data <- list(y = y,
                  ...
                  N0_sd = 10,
                  n.years = data.jags.W$jags.data2$n.years,
                  n.states = 1)
...
# These have been saved so commenting out 2021-03-25
# Running again with new data July 2023
saveRDS(loo.out, file = "RData/loo_all_W_only_Jul2023.rds")
saveRDS(filenames, file = "RData/filenames_W_only_Jul2023.rds")
...
saveRDS(results.list, file = "RData/W_only_results.rds")
